...
public interface BudgetStatusService {
    ...
    @Transactional
    BudgetStatus logicalRemove(Long id) throws NoContentException;

    Optional<BudgetStatus> findBudgetStatusByIdAndDeletedFalse(Long id) throws NoContentException;
