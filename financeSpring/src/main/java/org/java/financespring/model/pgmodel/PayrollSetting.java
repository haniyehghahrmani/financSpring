...
public class PayrollSetting extends Base {
    ...
    @Column(name = "p_tax_rate", precision = 5, scale = 2, nullable = false)
    ...
    @Column(name = "p_overtime_rate", precision = 5, scale = 2, nullable = false)
    ...
    // درصد بیمه کسرشونده
    @Column(name = "p_insurance_rate", precision = 5, scale = 2, nullable = false)
    ...
    @Column(name = "p_standard_monthly_hours", nullable = false)
