...
public class Attendance {
    ...
    @Column(name = "attendance_check_in_time", nullable = false)
    ...
    @Column(name = "attendance_check_out_time", nullable = false)
    ...
    @Column(name = "attendance_is_absent", nullable = false)
    @NotNull(message = "Absent flag must not be null")
    private boolean isAbsent = false;

    @Column(name = "attendance_is_on_leave", nullable = false)
    @NotNull(message = "Leave flag must not be null")
    private boolean isOnLeave = false;

    //میزان اضافه‌کاری
    @Column(name = "attendance_overtime_hours", nullable = false)
    ...
    @Column(name = "attendance_delay_minutes", nullable = false)
    ...
    @Column(name = "attendance_note", length = 1000)
